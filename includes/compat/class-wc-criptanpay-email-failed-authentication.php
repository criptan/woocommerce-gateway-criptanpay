 ...
 * @extends WC_Email
 */
abstract class WC_Criptanpay_Email_Failed_Authentication extends WC_Email {
	/**
	...
	public function get_authorization_url( $order ) {
		return add_query_arg( 'wc-criptanpay-confirmation', 1, $order->get_checkout_payment_url( false ) );
	}
	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
			'enabled'    => array(
				'title'   => _x( 'Enable/Disable', 'an email notification', 'woocommerce-gateway-criptanpay' ),
				'type'    => 'checkbox',
				'label'   => __( 'Enable this email notification', 'woocommerce-gateway-criptanpay' ),
				'default' => 'yes',
			),
