 ...
 *
 * @package WooCommerce_Criptanpay/Templates/Emails
 * @version 4.3.0
 */
	...
	echo esc_html(
		sprintf(
			...
			_x(
				...
				'woocommerce-gateway-criptanpay'
			),
...
<p><?php esc_html_e( 'The renewal order is as follows:', 'woocommerce-gateway-criptanpay' ); ?></p>
